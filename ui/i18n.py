...
_STRINGS: dict[str, dict[str, str]] = {
    ...
    "dep_gantt.mark_working_day": {"fr": "Marquer comme jour ouvré", "en": "Mark as working day"},
    "dep_gantt.mark_non_working_day": {"fr": "Marquer comme jour non ouvré", "en": "Mark as non-working day"},
    "dep_gantt.reset_day": {"fr": "Réinitialiser (auto)", "en": "Reset (auto)"},
